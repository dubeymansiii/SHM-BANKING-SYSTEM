...
?>
<div class="heading">
    <h3> Start your Transaction Now!</h3>
</div>
<div class="container">
            <div class="row">
                <div class="col">
                ...
                ?>
                    <tr>
                        ...
                        <td class="py-2 text-center "><a href="userdetails.php?id=<?php echo $rows['id'] ;?>"> <button type="button" style="background:rgb(17, 104, 138);;" class="btn">Transact</button></a></td>
                    </tr>
                <?php
                    }
                ?>
